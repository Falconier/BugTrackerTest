...
namespace BugTrackerTest.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Property,OldVal,NewVal,Changed,UserId")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,Property,OldVal,NewVal,Changed,UserId")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
